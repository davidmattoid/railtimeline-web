const CACHE = 'railtimeline-web-poc1-v1';
const ASSETS = ['./','./index.html','./styles.css','./app.js','./data/catalog.js','./data/pk.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
